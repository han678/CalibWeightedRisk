...
# code from https://github.com/maxc01/metacal
...
class MetaCalMisCoverage:
    ...
    def fit(self, xs, ys):
        ...
        ts_model.set_temp_from_logits(ts_x, ts_y)
    ...
    def predict(self, X):
        ...
        proba_cal[neg_ind] = self.base_model.predict_prob(X[neg_ind]).detach().cpu().numpy()
